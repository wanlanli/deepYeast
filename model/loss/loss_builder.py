...
def _create_loss_and_weight(
    loss_options: config_yml.SingleLossOptions, gt_key: Text,
  ...
  Args:
    loss_options: Loss options as defined by
      config_yml.LossOptions.SingleLossOptions or None.
...
class DeepLabFamilyLoss(tf.keras.layers.Layer):
  ...
  def __init__(
      self,
      loss_options: config_yml.LossOptions,
    ...
    Args:
      loss_options: Loss options as defined by config_yml.LossOptions.
    ...
    if hasattr(loss_options, common.SEMANTIC_LOSS):
    ...
    if hasattr(loss_options, common.CENTER_LOSS):
      self._single_term_loss_func_and_weight_dict[
    ...
    if hasattr(loss_options, common.REGRESSION_LOSS):
      self._single_term_loss_func_and_weight_dict[
