...
class DeepLabModule(tf.Module):
  ...
  def get_input_spec(self):
    ...
    return tf.TensorSpec(shape=[None, None, self._input_depth], dtype=tf.uint16)
...
if __name__ == '__main__':
  app.run(main)
"""
python export_model.py --experiment_option_path='./configs/config_wl.yaml' \
--checkpoint_path='../model_dir/deepyeast_001/ckpt-100000.index' \
--output_path = "../model_dir/save2"
"""  